...
public class Character_Lumia : PlayerCharacterBase
{
    ...
    protected override float SubAtatckCoolDown => subAttackCoolDown;
    ...
    [SerializeField] private float baseAttackRate = 8f;
    [SerializeField] private float baseAttackBulletSpeed = 10f;
    ...
    [SerializeField] private float subAttackBulletSpeed = 10f;
